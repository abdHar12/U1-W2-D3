...
while (ind < starWarsCharacters.length) {
  crewMass += starWarsCharacters[ind].mass;
  ind++;
}
console.log("La massa totale dei passeggeri è: " + crewMass);
...
for (let i = 0; i < femaleCharacters.length; i++) {
  for (let v = 0; v < characters.length; v++) {
    if (femaleCharacters[i].name === characters[v]) {
